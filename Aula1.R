...
par(mfcol=c(2,4),mar=c(5,4.5,3,1),cex.lab=1.6,cex.axis=1.4,
    cex.main=1.8)
hist(env$nit,col="pink",main="Histograma de Nitrato", xlab = "Nitrato (mg/L)", las=1)
qqnorm(env$nit,pch=21,col="black",bg="pink",cex=1.6, las=1)
qqline(env$nit,lty=2, las=1)
hist(env$amm,col="orange",main="Histograma de Amônio", xlab = "Amônio (mg/L)", las=1)
qqnorm(env$amm,pch=21,col="black",bg="orange",cex=1.6, las=1)
qqline(env$amm,lty=2, las=1)
hist(env$oxy,col="gray",main="Histograma de Oxigênio", xlab = "Oxigênio (mg/L)", las=1)
qqnorm(env$oxy,pch=21,col="black",bg="gray",cex=1.6, las=1)
qqline(env$oxy,lty=2, las=1)

hist(n100,col="gray",main="Histograma n=100", xlab = "Dados simulados", las=1)
qqnorm(n100,pch=21,col="black",bg="gray",cex=1.6, las=1)
qqline(n100,lty=2, las=1)
dev.off()
